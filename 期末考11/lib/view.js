        ...
        <div class="navbar" style="float:left">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              ${(user == null) ? '<a href="/user/signupForm">註冊</a>' : ''}
              ${(user == null) ? '<a href="/user/loginForm">登入</a>' : '<a href="/user/logout">登出</a>'}
              <a href="/">網站首頁</a>
            </div>
          </div>
          &nbsp;&nbsp;&nbsp;
...
V.post.list = function (board, posts, ctx) {
  ...
  */
  ...
  <div style="float:right">
    ...
    <p><a href="/"><button>回到首頁</button></a></p>
  </div>
  <h1>${board} 留言板</h1>
...
V.post.createForm = function (board, ctx) {
  ...
  <p><a href="/post/list?board=${post.board}"><button>回到貼文列表</button></a></p>
...
V.post.show = function (post, ctx) {
  ...
  <div style="float:right">
    ...
    <p><a href="/post/delete?board=${post.board}&file=${post.file}"><button>刪除貼文</button></a></p>
    <p><a href="/post/list?board=${post.board}"><button>回到貼文列表</button></a></p>
  </div>
  <h1>${post.title}</h1>
